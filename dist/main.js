$(document).ready(function() {
    ...
    function catsone() {
        function album() {
            ...
            var happy = "<div class='container-fluid'><div class='row-fluid'><div class='col-md-3'>" +
                ...
                name.picture6 +
                " class='img-responsive'><br/>photo 6</div><div class='col-md-1'></div></div></div></div></div>";
            console.log(name);
            $(".mainWrapper").html(happy);
        }
        album();
        $(".cats").css({
            "background": "red"
        ...
        $('.col-md-2').on("click", function(e) {
            $(".mainWrapper").html("<strong><div class='cathop'>back to cats album</div></strong>");
            $('.cathop').on("click", catsone);
    ...
    function dogsone() {
        function album() {
            ...
            var happy = "<div class='container-fluid'><div class='row-fluid'><div class='col-md-3' style='background:blue height:100%'>" +
        ...
        $(".walruses").on("click", walrusesone);
        $('.col-md-2').on("click", function(e) {
            $(".mainWrapper").html("<strong><div class='doghop'>back to dogs album</div></strong>");
            $('.doghop').on("click", dogsone);
            $(".mainWrapper").append(this);
            $(".col-md-2").css({
                "width": "100%"
            });
    ...
    function elephantsone() {
        function album() {
            ...
            var happy = "<div class='container-fluid'><div class='row-fluid'><div class='col-md-3' style='background:blue'>" +
        ...
        $(".walruses").on("click", walrusesone);
        $('.col-md-2').on("click", function(e) {
            $(".mainWrapper").html("<strong><div class='elephanthop'>back to elephants album</div></strong>");
            $('.elephanthop').on("click", elephantsone);
            $(".mainWrapper").append(this);
            $(".col-md-2").css({
                "width": "100%"
            });
    ...
    function apesone() {
        ...
        $(".walruses").on("click", walrusesone);
        $('.col-md-2').on("click", function(e) {
            $(".mainWrapper").html("<strong><div class='apehop'>back to apes album</div></strong>");
            $('.apehop').on("click", apesone);
            $(".mainWrapper").append(this);
            $(".col-md-2").css({
                "width": "100%"
            });
    ...
    function walrusesone() {
        ...
        $(".walruses").on("click", walrusesone);
        $('.col-md-2').on("click", function(e) {
            $(".mainWrapper").html("<strong><div class='walrushop'>back to walruses album</div></strong>");
            $('.walrushop').on("click", walrusesone);
            $(".mainWrapper").append(this);
            $(".col-md-2").css({
                "width": "100%"
            });
    ...
    function bunniesone() {
        function album() {
            ...
            var happy = "<div class='container-fluid'><div class='row-fluid'><div class='col-md-3' style='background:blue'>" +
                ...
                name.picture6 +
                " class='img-responsive'>photo 6<br/></div><div class='col-md-1'></div></div></div></div></div>";
            $(".mainWrapper").html(happy);
        }
        album();
        $(".bunnies").css({
        ...
        $(".walruses").on("click", walrusesone);
        $('.col-md-2').on("click", function(e) {
            $(".mainWrapper").html("<strong><div class='bunnyhop'>back to bunnies album</div></strong>");
            $('.bunnyhop').on("click", bunniesone);
            $(".mainWrapper").append(this);
            $(".col-md-2").css({
                "width": "100%"
            });
